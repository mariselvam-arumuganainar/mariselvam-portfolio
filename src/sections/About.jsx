...
const About = () => {
  const text = `Passionate about clean architecture
    I engineer modern, high-performance web applications
from scalable systems to pixel-perfect user experiences`;
...
🧠 Exploring UX patterns that blend design with engineering
